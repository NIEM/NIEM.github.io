...
| IEPD Catalog | The IEPD Catalog is an XML file that identifies, locates, and classifies key artifacts in an IEPD.  It also includes metadata such as points of contact.<br><br>This file has the name "iepd-catalog.xml" and resides in the IEPD root directory. |

...
{:.note}
> **[NIEM 5.0-rc5](https://github.com/NIEM/NIEM-Releases/releases/tag/niem-5.0rc5) is now available for review!**  Feedback is requested by Thursday, October 22, 2020.  Click **[here](#under-development-niem-50)** for more.
...
**[NIEM 5.0 release candidate 5](https://github.com/NIEM/NIEM-Releases/releases/tag/niem-5.0rc5)** is now available for review!

The release package is available at [NIEM-Releases](https://github.com/NIEM/NIEM-Releases/releases/tag/niem-5.0rc5) on GitHub and may also be downloaded as a [zip file](https://github.com/NIEM/NIEM-Releases/archive/niem-5.0rc5.zip).  The package includes XML schemas, documentation spreadsheets, a change log, a JSON-LD context file, and a README.

{: .note}
> Please email feedback to <niem-comments@lists.gatech.edu> or submit a new [5.0 issue](https://github.com/NIEM/NIEM-Releases/issues/new?labels=5.0) by **Thursday, October 22, 2020**.
...
Several changes have been made to CUI components based on RC4 feedback.  These are:

- Removed "Document" class term from from several CUI element and type names
- Replaced "LimitedDisseminationControl" with acronym "LDC" in CUI element and type names
- Renamed element cui:RequiredIndicatorsPerAuthoritiesText
...
Release Candidate (RC) 5 | Oct 2020 | [RC5 issues](https://github.com/NIEM/NIEM-Releases/milestone/12?closed=1) | QA and preparations for the release.  Only bug fixes are considered during this stage; other requests will be queued for the following release.
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <b>
          <a href="https://github.com/NIEM/NIEM-Releases/releases/tag/niem-5.0rc5">NIEM 5.0 rc5</a>
        </b>
        <br><i>(draft release)</i>
      </td>
      <td>
        <a href="https://github.com/NIEM/NIEM-Releases/tree/niem-5.0rc5">GitHub</a>
      </td>
      <td>2020</td>
      <td>
        <a href="https://github.com/NIEM/NIEM-Releases/archive/niem-5.0rc5.zip">Zip</a>
      </td>
      <td>
        <a href="https://github.com/NIEM/NIEM-Releases/blob/niem-5.0rc5/README.md">Readme</a>
      </td>
      <td>

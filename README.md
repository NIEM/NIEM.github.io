...
2. Please rebase any series of commits down to a single commit to be merged in
...
See the [wiki](https://github.com/NIEM/NIEM.github.io/wiki) for more details about editing and maintaining the site.
